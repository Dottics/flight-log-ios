...
class PersistenceContainer {
    ...
    static var preview: PersistenceContainer {
        ...
        flightLog2.dual = 1
        flightLog2.engineType = "multi"
        flightLog2.fstd = false
        ...
        flightLog2.pic = 0
        flightLog2.picus = 1
        flightLog2.pilotInCommand = false
        flightLog2.picName = "Jimmy Doolittle"
        ...
        flightLog3.pic = 0
        flightLog3.picus = 1
        flightLog3.pilotInCommand = false
        flightLog3.picName = "Jimmy Doolittle"
